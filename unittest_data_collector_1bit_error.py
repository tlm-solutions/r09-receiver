...
try:
    while True:
        ...
        print(f"[*] Collected {len(unittest_data)} telegrams with 1 bit error")
...
with open('unittest_data_1bit_error.json', 'w') as fp:
