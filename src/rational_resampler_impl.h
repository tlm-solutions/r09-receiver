...
class FILTER_API rational_resampler_impl
    : public rational_resampler<IN_T, OUT_T, TAP_T> {
private:
  unsigned d_history;
...
public:
  rational_resampler_impl(unsigned interpolation, unsigned decimation,
                          const std::vector<TAP_T> &taps, float fractional_bw);
